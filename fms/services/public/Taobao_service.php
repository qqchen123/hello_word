 ...
 * @desc 淘宝serivce
 */
class Taobao_service extends Admin_service
{
	/**
	 * @var table name 
	 */
	public $table_name = 'taobao_report';
	...
	/**
	 * @name 从魔蝎获取淘宝报告 落地到mongo
	 * @url https://api.51datakey.com/gateway/taobao/v6/data/{task_id}
	 * @param $mobile string
	 * @return boolean
	 */
	public function record_report($task_id)
	{
		$path = '/gateway/taobao/v6/data/' . $task_id;
