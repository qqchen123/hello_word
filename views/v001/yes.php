...
<div class="yespage" id="img1">
      <img src="/assets/images/web/head/yes.png" > 
</div>
<div class="redyes"> 
      <img src="/assets/images/web/head/yes1.png" > 
</div>
...
<script type="text/javascript">
    $('#img1').click(function(){
        ...
        if (-1 != class_name.indexOf('a1')) {
            $('#img1').removeClass('a1');
            $('#img1 img').attr('src', "/assets/images/web/head/yes.png");
        } else {
            $('#img1 img').attr('src', "/assets/images/web/head/yes1.png");
            $('#img1').addClass('a1');
        }
    });
</script>