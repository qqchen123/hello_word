<div id="{{form_id}}" style="width:800px;padding:10px 20px;top: 50px;" class="easyui-dialog" closed="true" buttons="jigou-dlg-buttons" data-options="modal:true">
    <input type="hidden" name="change-id" id="change-id" value="">
	<div id="change-form"></div>
    <div id="change-btn-box"></div>
</div>
<script type="text/javascript">
	var box_config = globalData['change_box_config'];
    var value = {};
    var div_box = '';
    ...
    $('#change-form').append(div_box);
    $('#change-btn-box').append(btn_box);
</script>