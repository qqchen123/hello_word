...
<div class="easyui-layout" data-options="fit:true,border:false">
	...
	<form id='fileform' method='post' action='<?php echo site_url('Qudao/addrec')?>' target="uploadFrame">
	<table class="table table-bordered" style="margin: 0;padding: 0px">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="q_code" id="q_code" class="col-sm-6" _required _valid="isAlphaOrNumbers" _msg="渠道编号错误" maxlength="25">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" class="align-center">
                <input type="hidden" name="formid" value="<?php echo $qid?>">
