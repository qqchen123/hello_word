...
<script>
    ...
    var col_data = [[
        ...
        {field: 'bankname', title: '开户行', width: 100,  align:'center'},
        {field: 'bankNo', title: '银行卡号', width: 200,  align:'center'},
        {field: 'uktype', title: '卡类型', width: 100, align:'center', halign:'center', 
            formatter: function(value, row, index) {
                return value;
            }},
        {field: 'is_default', title: '默认', width: 260, align:'center', halign:'center'},
            ...
            formatter: function(value, row, index) {
                ...
                //基础设置
                    ...
                    foreach ($this->sbtn_option as $key => $value) {
                        $this->sbtn_option->$key->method = 'bank' . ucfirst($this->sbtn_option->$key->method);
                    }
                //输出状态按钮
...
//##########################################
    ...
    //新增信息
    function add() {
        $.messager.prompt("增加银行卡", "请输入增加银行卡用户的身份证", function (idnumber) {
            if (idnumber) {
