    ...
    $("#listselect").append(
        nunjucks.render(
            AJAXBASEURL + tplPath + 'v001/select_basic', 
            {
                ...
                canSelect: <?= checkRolePower('Qiye', 'jdlist') ?>,
                expendBtn: [['拉取报告', '', 'get', <?= checkRolePower('Qiye', 'jdlist') ?>]] //https://api.51datakey.com/h5/importV3/index.html#/jingdong?apiKey=dd0171ba1b5f4b03a49375f4194b2b7e&userId=xiaoyougaotou_test
            }
        )
    );
        ...
        $.ajax({ 
            ...
            success : function(res){ 
                ...
                if (0 == res.code) {
                    ...
                    $("#dd").prepend(
                        nunjucks.render(
                            AJAXBASEURL + tplPath + 'v001/view_sample_box_basic', 
                            {boxwidth:'width:1600px;', data: JSON.stringify(res.data)}
                        )
                    );
                } else {
                    $("#dd").prepend(
