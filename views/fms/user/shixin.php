    ...
    <table class="table table-bordered" style="margin: 0;padding: 0px">
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                ...
                <a href="http://zxgk.court.gov.cn/shixin/new_index.html" target="_blank" style="text-decoration:none;">失信</a>
            </td>
        </tr>
        </tbody>
    </table>
...
<script type="text/javascript" src="/assets/apps/user/shixin.js?s=<?= time()?>"></script>
