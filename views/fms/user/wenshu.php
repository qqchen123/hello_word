    ...
    <table class="table table-bordered" style="margin: 0;padding: 0px">
        ...
        <tr>
            <td colspan="4" style="text-align: center;">
                ...
                <a href="http://wenshu.court.gov.cn/Index" target="_blank" style="text-decoration:none;">文书</a>
            </td>
        </tr>
        </tbody>
    </table>
...
<script type="text/javascript" src="/assets/apps/user/wenshu.js?s=<?= time()?>"></script>
