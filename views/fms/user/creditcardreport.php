...
<div class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div id="viewbox">
        <div id="dd" class="easyui-dialog" title="信用卡报告" style="width:1600px;height:700px;top: 10px;"data-options="iconCls:'icon-info',modal:true,closed:true">
        </div>
    </div>
</div><!-- /.page-content -->
<script>
    ...
    $("#listselect").append(
        nunjucks.render(
            AJAXBASEURL + tplPath + 'v001/select_basic', 
            {
                ...
                expendBtn: [['拉取报告', 'https://api.51datakey.com/h5/importV3/index.html#/banklist?apiKey=dd0171ba1b5f4b03a49375f4194b2b7e&userId=xiaoyougaotou_test&backUrl=http%3A%2F%2F47.94.133.229%2Ffms%2Findex.php%2FMx%2Fmx_recv&_k=bnodpu', 'get', <?= checkRolePower('Qiye', 'gjjlist') ?>]] 
            }
        )
    );
...
//#################################################
    ...
    $("#query").click(function(){
        ...
        $.ajax({ 
            type : "post", 
            url : AJAXBASEURL + 'Qiye/creditlist', 
            ...
            success : function(res){ 
                ...
                if (0 == res.code) {
                    ...
                    $("#dd").prepend(
                        nunjucks.render(
                            AJAXBASEURL + tplPath + 'v001/view_credit_card_box_basic.php', 
