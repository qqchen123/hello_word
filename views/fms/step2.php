...
<div class="easyui-layout" data-options="fit:true,border:false">
	...
	<form id='fileform' method='post' action='<?php echo site_url('qiye/step3')?>' enctype="multipart/form-data">
	<table class="table table-bordered" style="margin: 0;padding: 0px">
        ...
        <tr>
            ...
            <td class="tlabel"><?=iconv('gb2312','utf-8','婚姻情况');?></td>
            <td>
                <select name="bumenid" id="bumenid" class="col-sm-6">
                    <option value="00"><?=iconv('gb2312','utf-8','未婚');?></option>
                    <option value="01"><?=iconv('gb2312','utf-8','已婚');?></option>
        ...
        <tr>
            ...
            <td class="tlabel"><?=iconv('gb2312','utf-8','上传法人户口本');?></td>
            <td>
        ...
        <tr>
            <td colspan="4" class="align-center">
                ...
                <button type="submit" class="btn btn-success ml2" id="gostep3"><?=iconv('gb2312','utf-8','下一步 法人配偶信息');?></button>
				&nbsp;
