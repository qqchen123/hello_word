...
<div class="easyui-layout" data-options="fit:true,border:false">
	...
	<form id='fileform' method='post' action='<?php echo site_url('qiye/step8')?>' enctype="multipart/form-data">
	<table class="table table-bordered" style="margin: 0;padding: 0px">
		<tbody>
        
        <tr>
        	<td class="tlabel"><?=iconv('gb2312','utf-8','上传法人个人流水(半年)');?></td>
            <td>
        ...
        <tr>
            <td colspan="4" class="align-center">
                ...
                <button type="submit" class="btn btn-success ml2" id="gostep8"><?=iconv('gb2312','utf-8','下一步 其他认证信息');?></button>
                &nbsp;
